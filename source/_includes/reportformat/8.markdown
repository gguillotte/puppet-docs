...
This is the format of reports output by Puppet 5.3.8 and later, and Puppet 5.5.3 and later. Nothing in report format 7 was removed from report format 8, so it is backward-compatible.
